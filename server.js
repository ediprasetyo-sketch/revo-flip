...
// Chunk upload dikirim browser sebagai binary (application/octet-stream atau application/pdf).
// Fastify harus membaca body sebagai Buffer agar tidak menolak request dengan HTTP 415.
const binaryParser={parseAs:'buffer'};
const parseBinary=(req,body,done)=>done(null,body);
app.addContentTypeParser('application/octet-stream',binaryParser,parseBinary);
app.addContentTypeParser('application/pdf',binaryParser,parseBinary);
